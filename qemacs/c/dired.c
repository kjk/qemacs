...
typedef int mode_t;
extern int S_ISDIR(int mode);
extern int S_ISREG(int mode);

static int S_ISFIFO(int mode)
{
    return 0;
}

static int S_ISSOCK(int mode)
{
    return 0;
}

static int S_ISLNK(int mode)
{
    return 0;
}

static int S_ISCHR(int mode)
{
    return 1;
}

static int S_ISBLK(int mode)
{
    return 0;
}
