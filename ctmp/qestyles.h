    ...
    STYLE_DEF(QE_STYLE_DEFAULT, "default",
              QERGB(0x00, 0x00, 0x00), QERGB(0xff, 0xff, 0xff),
              QE_FAMILY_FIXED, 12)
    ...
    STYLE_DEF(QE_STYLE_MINIBUF, "minibuf",
              QERGB(0xff, 0x40, 0x00), COLOR_TRANSPARENT,
              0, 0)
    ...
    STYLE_DEF(QE_STYLE_PREPROCESS, "preprocess",
              QERGB(0x00, 0x5a, 0x5a), COLOR_TRANSPARENT,
              0, 0)
    STYLE_DEF(QE_STYLE_STRING, "string",
              QERGB(0xa3, 0x15, 0x15), COLOR_TRANSPARENT,
              0, 0)
    STYLE_DEF(QE_STYLE_KEYWORD, "keyword",
              QERGB(0x00, 0x1b, 0xff), COLOR_TRANSPARENT,
              0, 0)
    STYLE_DEF(QE_STYLE_FUNCTION, "function",
              QERGB(0x40, 0xaa, 0xa0), COLOR_TRANSPARENT,
              0, 0)
    STYLE_DEF(QE_STYLE_VARIABLE, "variable",
              QERGB(0x38, 0x8c, 0x40), COLOR_TRANSPARENT,
              0, 0)
    STYLE_DEF(QE_STYLE_TYPE, "type",
              QERGB(0x00, 0x1b, 0xaf), COLOR_TRANSPARENT,
              0, 0)
    STYLE_DEF(QE_STYLE_TAG, "tag",
              QERGB(0x00, 0x66, 0x11), COLOR_TRANSPARENT,
              0, 0)
